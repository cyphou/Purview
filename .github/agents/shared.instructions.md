---
description: "Shared rules for all agents in the Microsoft Purview to Demo migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — Microsoft Purview to Demo Migration
