# Multi-Agent Architecture — Microsoft Purview to Demo Migration
...
| **@extractor** | Parsing Microsoft Purview source artifacts | `src/` extraction modules |
...
```
        ...
        │(Microsoft Purview parse)│  │ (coord.)  │   │ (coord.)   │
        └──────┬─────┘   └─────┬─────┘   └─────┬──────┘
               │          ┌────┴────┐     ┌─────┴──────┐
               │          │         │     │            │
               │     ┌────▼───┐ ┌───▼───┐ ┌▼────────┐ ┌▼──────┐
...
| **Formula Correctness** | Valid syntax, correct conversion from Microsoft Purview formulas |
